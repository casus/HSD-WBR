...
from stardist.src.utils import _raise, backend_channels_last
from stardist.models.base_hydra import masked_loss_wbr
...
class ActivityRegularizationLayer(Layer):
    def __init__(self, wbr_loss_weight=0.5):
        super().__init__()
        self.wbr_loss_weight = wbr_loss_weight

    def call(self, concat,  mask=None):
        self.add_loss(self.wbr_loss_weight * masked_loss_wbr(mask)(mask, concat))
        return concat, mask
